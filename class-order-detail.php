...
if (!class_exists('Foodbakery_Order_Detail')) {
    ...
    class Foodbakery_Order_Detail {
        ...
        public function order_price($order_id = '') {
            ...
            $foodbakery_discount_price = get_post_meta($order_id, 'foodbakery_discount_price', true);
                                    ...
                                    <li class="order-type total-price">
                                        ...
                                        <span><?php
                                            if ($check_delivery_fee) {
                                                ...
                                                echo restaurant_menu_price_calc('defined', $order_subtotal_price, $menu_order_fee, true, false, false, '', true, $foodbakery_discount_price);
                                            }
                                            ?></span>
                                    </li>
                                <?php } ?>
